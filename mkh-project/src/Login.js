            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                      ...
                      <div>
                    <button type="submit" class="w-full mt-2 mb-2 text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-md text-sm px-5 py-2.5 text-center">Login</button>
                  </div>
                    <p class="text-sm font-light text-black-600">
                        Don't have acount? <a href="#" class="font-bold text-primary-600 hover:underline">Register Now</a>
                    </p>
                </form>
            </div>
        </div>
